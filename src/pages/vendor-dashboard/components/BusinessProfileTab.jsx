  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      {approvalStatus === 'pending' && (
        <div className="flex items-start gap-3 p-4 rounded-lg" style={{ background: 'rgba(201,168,76,0.1)', border: '1px solid rgba(201,168,76,0.4)' }}>
          <Icon name="Clock" size={18} color="#C9A84C" className="flex-shrink-0 mt-0.5" />
          <div>
            <p className="text-sm font-semibold" style={{ color: '#C9A84C' }}>Pending Admin Approval</p>
            <p className="text-xs mt-0.5" style={{ color: '#9BA4E8' }}>Your business profile is under review. You can continue editing while we review your listing.</p>
          </div>
        </div>
      )}
